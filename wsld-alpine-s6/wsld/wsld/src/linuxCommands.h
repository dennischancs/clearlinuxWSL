...
{
    // return "service docker start";  // ubuntu wsl image
    return ". /entrypoint.sh";         // alpine wsl image [using openrc special prepare]
    // return "mkdir -p /run/openrc; touch /run/openrc/softlevel; rc-status; rc-service docker start"; // entrypoint.sh
